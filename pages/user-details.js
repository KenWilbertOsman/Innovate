...
<div className="col-span-1 rounded-xl overflow-hidden h-96 w-full">
                <img className="rounded w-full h-full" src='https://developers.google.com/static/maps/images/landing/hero_maps_static_api.png'></img>
            </div>
    ...
    <div class = "flex flex-col min-h-screen">
      <footer class="p-4 bg-theme-beige sm:p-6 mt-auto">
          
    <div class="mb:justify-evenly">
        
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                <h2 class="mb-6 text-xl font-semibold text-gray-900 uppercase dark:text-white">Resources</h2>
            ...
            <div>
                <h2 class="mb-6 text-xl font-semibold text-gray-900 uppercase dark:text-white">Follow us</h2>
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
            ...
            <div>
                <h2 class="mb-6 text-xl font-semibold text-gray-900 uppercase dark:text-white">Legal</h2>
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
