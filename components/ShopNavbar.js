    ...
    return (
        <nav className="p-7 bg-gradient-to-r from-slate-100 to-theme-blue ">   {/*USING TAILWIND:  Border bottom and padding 6*/}
            ...
            <div className="flex flex-wrap mt-4">     {/**This div to hold link, mt-4 = Margin top 4 */}
                ...
                <div class="relative flex items-center lg:ml-auto md:ml-auto">
                    <label for="warehouse" class="text-theme-dream-2">Default Warehouse:</label>
                    <select id="warehouse" class="block bg-white border border-gray-300 text-gray-700 pl-2 pr-2 rounded-md leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                        <option value="1" class="py-2">Warehouse 1</option>
                        <option value="2" class="py-2">Warehouse 2</option>
                    </select>
                    <button class=" flex items-center px-4 text-white bg-theme-peach" type="submit">
